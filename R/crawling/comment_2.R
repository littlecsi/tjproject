...
for(y in year) {
  ...
  for(m in month) {
    ...
    for(d in day) {
      ...
      url <- 'https://news.naver.com/main/ranking/popularMemo.nhn?rankingType=popular_memo&sectionId=104&date='
    ...
    file <- paste('D:/GitHub/tjproject/R/resources/', y, '_comment_data_world.xlsx', sep='')
